...
public class UserController extends BaseManagerController
{
	...
	public Object listData(DataTableReqDto dataTableReqDto, HttpServletRequest request)
	{
		...
		//		long total = aclService.countTotalAccounts();//EnvParameter.get().getDomain()
		//		List<Account> accounts = aclService.queryAccounts(dataTableReqDto.getStart(), dataTableReqDto.getLength());
		//
		//		List<Object[]> list = new ArrayList<Object[]>();
		//		for (Account account : accounts)
		//		{
		//			Object[] ss = new Object[6];
		//			ss[0] = account.getUsername();
		//			ss[1] = account.getNickname();
		//			ss[2] = account.getCreateDate().toGMTString();
		//			ss[3] = (null != account.getLastLoginDate()) ? account.getLastLoginDate().toGMTString() : null;
		//			ss[4] = account.getId();
		//			list.add(ss);
		//		}
		//		
