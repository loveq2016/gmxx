...
background: #CF7A7A
    	...
    	<div class="main">
    		<form action="<%=basePath%>blog/add.htm" method="post" class="basic-grey">
				...
				<input type="hidden" style="width:80%" name="type" value="${blog.type}"/>
				<!-- <br/>
				<br/> -->
				...
				<label for="author">跳转链接：</label>
				<input type="text" style="width:80%" name="link" value="${blog.link}"/>
				<br/>
				<br/>
				...
				<!-- <input type="radio" name="needSync" value="true" /> 同步
				<input type="radio" name="needSync" value="false" checked="checked" /> 不同步<br> -->
				<input type="radio" name="canComment" value="true" />  允许评论
				<input type="radio" name="canComment" value="false" checked="checked" /> 禁止评论<br>
				<input type="radio" name="needLogin" value="true" /> 登陆可见
				<input type="radio" name="needLogin" value="false" checked="checked" /> 游客可见<br>
