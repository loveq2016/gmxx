...
background: #CF7A7A
    	...
    	<div class="main">
    		<form action="<%=basePath%>blog/modify.htm" method="post" class="basic-grey">
    			...
    			<input type="hidden" name="meidaType" value='LIVE'/>
				...
				<input type="text" name="link" id="content" value="${blog.link}" style="width:80%"/>
				<br/>
				...
				<label for="author">验证码：</label>
				<input type="text" style="width:80%" name="authCode" value="${blog.authCode}"/>
				<br/>
