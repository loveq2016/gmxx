			...
			<div class="panel-body">
				...
				<div class="row">
					<div style="margin-bottom: 10px" class="col-md-4">
						<img class="img-thumbnail" src="http://cdn.goldskyer.com/template/proton/assets/img/gallery/photo1.jpg"
							alt="Sample Image">
					</div>
					<div style="margin-bottom: 30px" class="col-md-4">
						<img class="img-thumbnail" src="http://cdn.goldskyer.com/template/proton/assets/img/gallery/photo2.jpg"
							alt="Sample Image">
					</div>
				</div>
			</div>
