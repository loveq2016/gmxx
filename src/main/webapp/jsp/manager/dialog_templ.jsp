...
<html lang="en">
	...
	<link rel="stylesheet" href="//cdn.goldskyer.com/library/upload-img/control/css/zyUpload.css" type="text/css">
		...
		<link href="//cdn.goldskyer.com/library/jbox-v2.3/jBox/Skins2/Blue/jbox.css" rel="stylesheet">		
		
		<script src="//cdn.goldskyer.com/template/proton/assets/js/jquery-2.1.1.min.js"></script>
...
<body>
	...
	<!-- self -->
		<script type="text/javascript" src="//cdn.goldskyer.com/library/laydate/laydate.dev.js"></script>
	...
	<script type="text/javascript" src="//cdn.goldskyer.com/library/upload-img/core/zyFile.js"></script>
	<script type="text/javascript" src="/manager/js/common/zyUpload.js"></script>
	
	<script type="text/javascript" src="//cdn.goldskyer.com/library/jbox-v2.3/jBox/jquery.jBox-2.3.min.js"></script>
	<script type="text/javascript" src="//cdn.goldskyer.com/library/jbox-v2.3/jBox/i18n/jquery.jBox-zh-CN.js"></script>
