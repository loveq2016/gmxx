...
<body>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image:url(//storage.goldskyer.com/gmxx/images/home_bg01.jpg)">
            </div>
            <div class="swiper-slide" style="background-image:url(//storage.goldskyer.com/gmxx/images/home_bg02.jpg)">
            </div>
            <div class="swiper-slide" style="background-image:url(//storage.goldskyer.com/gmxx/images/home_bg03.jpg)">
            </div>
        </div>
    ...
    <div class="circle">
        ...
        <a href="#" class="center">    
            <img class="logo_img" src="//storage.goldskyer.com/gmxx/images/logo.png">
        </a>
    </div>
