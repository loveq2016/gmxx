		...
		<tbody>
			<tr>
				<td width="109" height="34"><img
					src="//cdn.goldskyer.com/spring/index_files/web_l.gif" width="109"
					height="34"></td>
				<td width="867"
					background="//cdn.goldskyer.com/spring/index_files/web_c.gif"><table
							...
							<tr>
								<c:forEach var="child" items="${friendLink.children}">
									<td width="175" align="center"><select id="friendsitelist"
										onchange="if(this.options[this.selectedIndex].value!=&#39;&#39;){location=this.options[this.selectedIndex].value;}"><option
				...
				<td width="24"><img
					src="//cdn.goldskyer.com/spring/index_files/web_r.gif" width="24"
					height="34"></td>
			</tr>
		</tbody>
	</table></c:if>
		...
		<tbody>
			<tr>
				<td height="207" align="center" valign="middle"
					background="//cdn.goldskyer.com/spring/index_files/bottom_bg.gif"><table
