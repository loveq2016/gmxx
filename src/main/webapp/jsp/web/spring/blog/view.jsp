...
<script type="text/javascript" src="//cdn.goldskyer.com/spring/index_files/util.js"></script>
<script type="text/javascript" src="//cdn.goldskyer.com/spring/index_files/effects.js"></script>
<script type="text/javascript" src="//cdn.goldskyer.com/spring/index_files/dragdrop.js"></script>
<script type="text/javascript" src="//cdn.goldskyer.com/spring/index_files/controls.js"></script>
<script language="javascript" type="text/javascript"
...
<body>
						...
						<tbody>
							<tr>
								<td class="toolBar" height="47" valign="middle"
									background="//cdn.goldskyer.com/spring/index_files/zw_top.gif" colspan="3"></td>
							</tr>
							<tr>
								<td height="12" colspan="3"><img
									src="//cdn.goldskyer.com/spring/index_files/zw02.gif" width="980" height="12"></td>
							</tr>
							<tr>
								<td background="//cdn.goldskyer.com/spring/index_files/zw-left.gif" width="20"></td>
								<td width="944">
										...
										<tbody>
											...
											<tr>
												<td height="24" align="center" valign="middle"><span>${lang.author[n18]}：<a
													...
													<span>${lang.clickCount[n18]}：${blog.viewCount}</span> <span>${lang.releaseTime[n18]}：<fmt:formatDate value="${blog.updateDate}" pattern="yyyy-MM-dd"/></span></td>
											</tr>
											<tr>
												<td>${blog.content}</td>
											</tr>
											<tr>
												...
												</span><c:if test="${blog.canComment}"><span>【<a class="my-comment">${lang.postComment[n18]}</a>】</span></c:if> <span id="content_signin"></span><span
										      ...
										      <td>
											      <div class="sendCmt">
											          <div class="input-comment">
											              <textarea class="input-txt" row="6" placeholder="${lang.wantSaySonthing[n18]}"></textarea>
											          </div>
											          ...
											          <div class="history_comment">
												          <div class='hc_list'>
												          		 <c:forEach var="c" items="${comments}">
												          			<div class='hc_left'><img class='hc_img' src='//storage.goldskyer.com/gmxx/images/header.jpg' ></div>
												          			<div class='hc_right'>
								...
								<td background="//cdn.goldskyer.com/spring/index_files/zw-right.gif" width="16"></td>
							</tr>
							<tr>
								<td height="10" colspan="3"><img
									src="//cdn.goldskyer.com/spring/index_files/zw03.gif" width="980" height="10"></td>
							</tr>
							<tr>
	...
	<script language="JavaScript" type="text/JavaScript"
	src="https://cdn.goldskyer.com/spring/index_files/jquery.min.js"></script>
	<script>
	...
	jQuery(".button").on('click', function() {
				...
				jQuery.ajax({
					...
					success: function(data){
						...
						hc_list += "<img class='hc_img' src='//storage.goldskyer.com/gmxx/images/header.jpg' >";
						hc_list += "</div>";
