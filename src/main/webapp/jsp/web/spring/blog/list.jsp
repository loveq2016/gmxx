...
<link href="//cdn.goldskyer.com/spring/index_files/bhsx.css"
               ...
               <c:forEach var="tab" items="${blogTabs}" varStatus="stat">
                <tr>
                 <td class="toolBar" height="47" valign="middle"
                  background="//cdn.goldskyer.com/spring/index_files/article_bg.gif"
                ...
                <tr>
                 ...
                 <img src="//cdn.goldskyer.com/spring/index_files/article02.gif"width="736" height="12">
                 </td>
                </tr>

                <tr>
                 <td background="//cdn.goldskyer.com/spring/index_files/a-left.gif"
                  width="20"></td>
                        ...
                        <tbody>
                         <tr>
                          <td width="3%" valign="middle"
                           class="linetext"><img
                           src="//cdn.goldskyer.com/spring/index_files/article_common5.gif"
                 ...
                 <td
                  background="//cdn.goldskyer.com/spring/index_files/a-right.gif"
                  width="16"></td>
                </tr>

                <tr>
                 <td height="10" colspan="3"><img
                  src="//cdn.goldskyer.com/spring/index_files/article03.gif"
                ...
                <tr>
                 <td valign="top" width="100%"><table border="0"
                   ...
                   <tbody>
                    ...
                    <tr>
                     <td
                      background="//cdn.goldskyer.com/spring/index_files/a-left.gif"
                      width="20"></td>
                     <td width="700">
                      <table border="0" cellspacing="0" cellpadding="0"
                       width="700">
