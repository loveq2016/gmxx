...
<title>${cms.title.content}&gt;&gt; 首页</title>
	<link href="//cdn.goldskyer.com/spring/index_files/swiper.min.css"
	rel="stylesheet" type="text/css">
<script language="javascript" type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/prototype.js"></script>
<script language="javascript" type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/scriptaculous.js"></script>
<script type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/util.js"></script>
<script type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/effects.js"></script>
<script type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/dragdrop.js"></script>
<script type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/controls.js"></script>
<script language="javascript" type="text/javascript"
	src="//cdn.goldskyer.com/spring/index_files/checklogin.js"></script>
<script language="JavaScript" type="text/JavaScript"
	src="//cdn.goldskyer.com/spring/index_files/menu.js"></script>
<script language="JavaScript" type="text/JavaScript"
	src="//cdn.goldskyer.com/spring/index_files/jquery.min.js"></script>
<script type="text/JavaScript" src="//cdn.goldskyer.com/spring/index_files/swiper.jquery.min.js"></script>
<script language="JavaScript" type="text/JavaScript">
<!--
/*第一种形式 第二种形式 更换显示样式*/
...
<link href="//cdn.goldskyer.com/spring/index_files/bhsx.css" rel="stylesheet" type="text/css">
	<style type="text/css">
	.swiper-container {
		width: 275px;
		height: 188px;
																	...
																	<tbody>
																	    ...
																	    <tr>
																			<td width="10" valign="top" class="linetext"><img
																				src="//cdn.goldskyer.com/spring/index_files/Article_common4.gif"
																				alt="普通公告"></td>
												...
												<td>
													<table width="100%" cellpadding="0" cellspacing="0">
														<tbody>
															<!-- <tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://xcxx.szgm.edu.cn/Main.aspx"
																	title="办公OA" target="_self" style="padding-left:5px;">办公OA</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://www.qtxiaoxin.com/"
																	title="蜻蜓校信" target="_self" style="padding-left:5px;">蜻蜓校信</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://192.168.18.10:81"
																	title="旧校园网" target="_self" style="padding-left:5px;">旧校园网</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://192.168.18.4/sdms/index.asp"
																	title="成绩库" target="_self" style="padding-left:5px;">成绩库</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://192.168.18.10/xcxxhqserver/dktk/frmDkTk.htm"
																	title="调课系统" target="_self" style="padding-left:5px;">调课系统</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://192.168.18.4:8088/userLogin.asp"
																	title="办公系统" target="_self" style="padding-left:5px;">办公系统</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://192.168.18.10:9008/"
																	title="世纪阳光" target="_self" style="padding-left:5px;">世纪阳光</a></td>
															</tr>
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/icon.gif" style="margin-top:8px;"></td>
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="http://192.168.18.8"
																	title="FTP服务器" target="_self" style="padding-left:5px;">FTP服务器</a></td>
															</tr> -->
															<c:forEach var="m" items="${innerLink.children}" >
																...
																<td class="linetext"><a class="bannerLeft3_linetext"
																	href="${m.link}"
																	title="${m.name}" target="_self" style="padding-left:5px;">${m.name}</a></td>
																</tr>
															</c:forEach>
														</tbody>
													</table>
													...
													<table width="100%" cellpadding="0" cellspacing="0">
														<tbody>
															<c:forEach var="blog" items="${bannerLeft2s}">
																<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/Article_ontop4.gif"
																	alt="固顶文章"></td>
						...
						<tbody>
							<tr>
								<td height="49" width="47"><img
									src="//cdn.goldskyer.com/spring/index_files/dh1.gif"
									width="47" height="49"></td>
								<td
									background="//cdn.goldskyer.com/spring/index_files/dh2.gif"
									width="528">您现在的位置：&nbsp;<a class="LinkPath"
									href="http://www.bhsx.cn/">下村小学</a>&nbsp;&gt;&gt;&nbsp;首页
								</td>
								<td height="49"
									background="//cdn.goldskyer.com/spring/index_files/dh3.gif"
									width="25"><img
									src="//cdn.goldskyer.com/spring/index_files/taiyang.gif"
...
document.write("  " + weekday[d.getDay()])//输出星期
										...
										<tbody>
											<tr>
												<td height="30"><a href="javascript:void();"><img
														border="0"
														src="//cdn.goldskyer.com/spring/index_files/newsbg.gif"
											...
											<tr>
												<td>
													<table border="0" cellspacing="0" cellpadding="0"
														...
														<tbody>
															<tr>
																<td height="188" valign="center" width="275"
																	align="middle">
	<div class="swiper-container">
	<div class="swiper-wrapper">
	<div class="swiper-slide" style="background-image:url(//storage.goldskyer.com/gmxx/upload/images/20160604/1465022388757068245.jpg)">
	</div>
	<div class="swiper-slide" style="background-image:url(//storage.goldskyer.com/gmxx/upload/images/20160604/1465022461564069994.jpg)">
	</div>
	<div class="swiper-slide" style="background-image:url(//storage.goldskyer.com/gmxx/upload/images/20160604/1465022501383080951.jpg)">
	</div>
	</div>
	<div class="swiper-pagination"></div>
	</div>
																		<script
																		src="//cdn.goldskyer.com/spring/index_files/sohuflash_1.js"
																	...
																	<table width="100%" cellpadding="0" cellspacing="0">
																		<tbody>
																			<c:forEach var="blog" items="${bannerTops}" >
																				<tr>
																				<td width="10" valign="top" class="linetext"><img
																					src="//cdn.goldskyer.com/spring/index_files/Article_common4(1).gif"
																					alt="普通文章"></td>
										...
										<tbody>
											...
											<tr>
												<td height="19" colspan="3"><img
													src="//cdn.goldskyer.com/spring/index_files/dl01.gif"
													width="211" height="19"></td>
											</tr>
											<tr>
												<td height="153"
													background="//cdn.goldskyer.com/spring/index_files/dlleft.gif"
													width="10"></td>
												...
												<td
													background="//cdn.goldskyer.com/spring/index_files/dlright.gif"
													width="10"></td>
											</tr>
											<tr>
												<td height="23" colspan="3"><img
													src="//cdn.goldskyer.com/spring/index_files/dl4.gif"
						...
						<tbody>
							...
							<tr>
								...
								<td width="738" align="middle"><object
										data="//cdn.goldskyer.com/spring/index_files/bannertwo.swf"
	...
	<script
		src="//cdn.goldskyer.com/spring/index_files/CA111761353603847750003.js"
...
<a href="http://webscan.360.cn/index/checkwebsite/url/xcxx.goldskyer.com"><img border="0" src="http://img.webscan.360.cn/status/pai/hash/7ec353e4f1069d43d40c19cf7fbe055c"/></a>
</body>
</html>