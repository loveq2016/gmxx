			...
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="750"
					...
					<tbody>
						<tr>
							<td height="50" width="375"><div class="item-title">${banner01}</div><a
								href="javascript:void();"><img border="0"
									src="//cdn.goldskyer.com/spring/index_files/dyzc.gif"
									width="375" height="50"></a></td>
							<td height="50" width="375"><div class="item-title">${banner02}</div><a href="javascript:void();"><img border="0"
									src="//cdn.goldskyer.com/spring/index_files/jxtd.gif"
									width="375" height="50"></a></td>
						</tr>
						<tr>
							<td height="25" valign="top"
								background="//cdn.goldskyer.com/spring/index_files/hd_top.gif"
								align="left"></td>
							<td valign="top"
								background="//cdn.goldskyer.com/spring/index_files/hd_top.gif"
						...
						<tr>
							<td valign="top"
								background="//cdn.goldskyer.com/spring/index_files/hd_cen.gif"
								align="left">
								<div id="Tab4">
									<div class="Menufour">
										<ul>
														...
														<c:forEach var="blog" items="${list}">
															<tr>
																<td width="10" valign="top" class="linetext"><img
																	src="//cdn.goldskyer.com/spring/index_files/Article_common4(3).gif"
																	alt="普通文章"></td>
						...
						<tr>
							<td height="25" valign="top"
								background="//cdn.goldskyer.com/spring/index_files/hd_bot.gif"
								align="left"></td>
							<td height="25" valign="top"
								background="//cdn.goldskyer.com/spring/index_files/hd_bot.gif"
								align="left"></td>
