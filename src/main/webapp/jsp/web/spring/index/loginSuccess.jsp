...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
    	...
    	<tr><td style="text-align:center">你有${unReadCnt}条未读消息,<a href="/manager/message/list.htm" target="_blank">点击阅读</a></td><tr>
    	<tr><td style="text-align:center;padding-top:20px"><a id="logout" href="/manager/index.htm" target="self">点此登陆后台</a></td><tr>
