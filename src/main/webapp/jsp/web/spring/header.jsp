...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <div style="background: url('//cdn.goldskyer.com/spring/index_files/topPic3_meitu_1_meitu_3.jpg') no-repeat center; width: 1000px;
  height: 240px;">
  ...
  <tr>
    ...
    <c:forEach var="menu" items="${cachedMenu.children}" >
    	<c:if test="${menu.hide==false &&(!menu.needLogin || (menu.needLogin && sessionScope.accountId!=null) )}">
    		      <a class="Channel" href="/web/spring/blog/list.htm?blogType=${menu.name}" target="_self" title="">${menu.name}</a>|
    	</c:if>
  	</c:forEach>
    </td>
  </tr>
